...
public class QuServiceImpl extends ServiceImpl<QuMapper, Qu> implements QuService {
    ...
    @Override
    public List<Qu> listByType(String repoId, Integer quType) {
        return baseMapper.listByType(repoId, quType);
    }
    ...
    @Override
    public void updateWrongCount(String id) {
        baseMapper.updateWrongCount(id);

    }

    @Override
    public void updateLevel(String id) {
        baseMapper.updateLevel(id);
    }
