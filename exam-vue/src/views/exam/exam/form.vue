  ...
  <div class="app-container">
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-form ref="postForm" :model="postForm" :rules="rules" label-position="left" label-width="120px">
        ...
        <el-form-item label="期望平均分" prop="examDiff">
          <el-input-number min = "0" v-model="postForm.examDiff" :max="postForm.totalScore"/>
        </el-form-item>

        <el-form-item label="及格分" prop="qualifyScore">
          <el-input-number min ="0" v-model="postForm.qualifyScore" :max="postForm.totalScore" />
        </el-form-item>
    ...
    <el-card style="margin-top: 20px;">
      ...
      <el-radio-group v-model="postForm.openType" style="margin-bottom: 20px">
        ...
        <el-radio :label="2" border>班级开放</el-radio>
      </el-radio-group>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        examDiff: [
          {required: true, message : '期望平均分不能为空! '}
        ],
        totalTime: [
